...
3: Select/upload a dataset and click "Spatial Heatmap" to see the plots.   
...
4: Step2: Select one method from 4.1 and click "Run" (4.2), then a cluster or network module showing highly similar expression patterns with the query will be identified in the subsetted matrix from step1, and the results will be shown in 4.3A, 4.3B, or 4.3C respectively.  
...
5: Step3: optional further network analysis on the cluster in 4.3A-C. This tab is disabled until the cluster is shown in 4.3A-C.    
